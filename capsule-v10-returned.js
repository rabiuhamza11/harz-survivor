// CAPSULE v10-RETURNED — PUBLIC DATA FILE (death test v4 final book).
// The book after the anchor-gated return: 17 records, 33 seals, walkout CLOSED.
// Return executed by the SEALED engine bytes (f69339b6) at the witness seat
// (2026-09-13T11:45Z) per the documented v0.6 precedent, after Node A's live
// /walkout/return refused fail-closed twice ("ANCHOR UNREACHABLE" — Cloudflare
// Workers egress cannot reach the public ledger mirrors; same as the v3 egress
// finding). Anchor proof in return seal #33: anchored_base e4c4a4a3... found in
// the public ledger (raw.githubusercontent mirror). D1 ingestion on Node A
// performed as disclosed unsealed substrate update (same inserts as the route
// glue), owner GO received. Final digest: 8fbaa547264d07f0ff07c2862d4c448312ea1be696f7eb5172eaaefa1d4a6009.
// Records 14-17 are the death-window history from Node C (HARZ-owned soil):
// 14 witness write, 15 owner hand-write "Harz", 16-17 labeled tamper evidence.
const CAPSULE = {
 "ok": true,
 "manifest": {
  "name": "HARZ Portable App",
  "version": "0.7.0-returned",
  "contract": "walkout-contract v0.7 — state + UI + code + writes + MULTI-MIRROR ANCHOR walk",
  "program": "P11 — death test v4 returned (witness-seat sealed return, anchor-verified; applied to Node A live)",
  "origin": {
   "substrate": "cloudflare-workers",
   "account_label": "harz (account 3)",
   "store": "D1 portable-app"
  },
  "exported": "2026-09-13T11:45:00Z"
 },
 "ui_manifest": {
 ...
 "code_manifest": {
  "/engine.js": "f69339b6f08a8b17ebe38870ed2ca2ec491e4ba5b6cca2ced0b247550860ecb2"
 },
 "code": {
 ...
 "digest": "e4c4a4a31b531cb3c8889a36105e2737ed6e96d2a9af1f08b47960960e25c1a0",
 "verify": {
  "ok": true,
  "issues": []
 }
